...
//------------------------------------------------------------------------------------
$('#subscribe-field-discount-form').validate({
    onfocusout: false,
    onkeyup: false,
    rules: {
    },
...
$('#subscribe-field-discount-form').submit(function () {
    // submit the form
    //data area
    var data = [];
    ...
    if ($(this).valid()) {
        ...
        $.ajax({
            ...
            processData: false,
            success: function () {
                $('#subscribe-field-discount-form').find('[type=submit]').button('complete');
            },
            error: function () {
                $('#subscribe-field-discount-form').find('[type=submit]').button('reset');
            }
        });
    } else {
