...
//------------------------------------------------------------------------------------
$('#footer-list-subscribe-form').validate({
    onfocusout: false,
    onkeyup: false,
    rules: {
		EMAIL: "required",
...
$('#footer-list-subscribe-form').submit(function () {
    // submit the form
    //data area
    var data = [];
    ...
    if ($(this).valid()) {
        ...
        $.ajax({
            ...
            processData: false,
            success: function () {
                $('#footer-list-subscribe-form').find('[type=submit]').button('complete');
            },
            error: function () {
                $('#footer-list-subscribe-form').find('[type=submit]').button('reset');
            }
        });
    } else {
