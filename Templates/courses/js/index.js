...
function initialize_contact_text_img_map_map() {
    ...
    map = new google.maps.Map(document.getElementById('contact-text-img-map-map'), mapOptions);
...
initialize_contact_text_img_map_map();
