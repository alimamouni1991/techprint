...
function initialize_contact_map_text_btn_map() {
    ...
    map = new google.maps.Map(document.getElementById('contact-map-text-btn-map'), mapOptions);
...
initialize_contact_map_text_btn_map();
//------------------------------------------------------------------------------------
//						CONTACT FORM VALIDATION'S SETTINGS
//------------------------------------------------------------------------------------
