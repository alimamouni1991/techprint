...
//------------------------------------------------------------------------------------
$('#header-slogan-form-form').validate({
    onfocusout: false,
    onkeyup: false,
    rules: {
		NAME: "required",
...
$('#header-slogan-form-form').submit(function () {
    // submit the form
    //data area
    var data = [];
    ...
    if ($(this).valid()) {
        ...
        $.ajax({
            ...
            processData: false,
            success: function () {
                $('#header-slogan-form-form').find('[type=submit]').button('complete');
            },
            error: function () {
                $('#header-slogan-form-form').find('[type=submit]').button('reset');
            }
        });
    } else {
