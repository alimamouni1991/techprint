...
//------------------------------------------------------------------------------------
$('#header-img-subscribe-videobg-form').validate({
    onfocusout: false,
    onkeyup: false,
    rules: {
    },
...
$('#header-img-subscribe-videobg-form').submit(function () {
    // submit the form
    //data area
    var data = [];
    ...
    if ($(this).valid()) {
        ...
        $.ajax({
            ...
            processData: false,
            success: function () {
                $('#header-img-subscribe-videobg-form').find('[type=submit]').button('complete');
            },
            error: function () {
                $('#header-img-subscribe-videobg-form').find('[type=submit]').button('reset');
            }
        });
    } else {
