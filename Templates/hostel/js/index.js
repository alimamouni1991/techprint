...
//------------------------------------------------------------------------------------
$('#header-center-slogan-form-3-form').validate({
    onfocusout: false,
    onkeyup: false,
    rules: {
		NAME: "required",
...
$('#header-center-slogan-form-3-form').submit(function () {
    // submit the form
    //data area
    var data = [];
    ...
    if ($(this).valid()) {
        ...
        $.ajax({
            ...
            success: function () {
                $('#header-center-slogan-form-3-form').find('[type=submit]').button('complete');
            },
            error: function () {
                $('#header-center-slogan-form-3-form').find('[type=submit]').button('reset');
            }
        });
    } else {
