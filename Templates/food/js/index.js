...
function initialize_contact_center_text_map_map() {
    ...
    map = new google.maps.Map(document.getElementById('contact-center-text-map-map'), mapOptions);
...
initialize_contact_center_text_map_map();
