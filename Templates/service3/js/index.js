...
//------------------------------------------------------------------------------------
$('#header-center-subscribe-img-form').validate({
    onfocusout: false,
    onkeyup: false,
    rules: {
		EMAIL: "required",
...
$('#header-center-subscribe-img-form').submit(function () {
    // submit the form
    //data area
    var data = [];
    ...
    if ($(this).valid()) {
        ...
        $.ajax({
            ...
            processData: false,
            success: function () {
                $('#header-center-subscribe-img-form').find('[type=submit]').button('complete');
            },
            error: function () {
                $('#header-center-subscribe-img-form').find('[type=submit]').button('reset');
            }
        });
    } else {
